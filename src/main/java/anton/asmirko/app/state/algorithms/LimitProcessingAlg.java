...
import anton.asmirko.app.model.commands.CreateLimitCommand;
...
@Component(CreateLimitCommand.STR_REP)
@RequiredArgsConstructor
public class CreateLimitProcessingAlg implements CLICommandProcessingAlg<CreateLimitCommand> {

    private final LimitService limitService;

    @Override
    public FsmState process(CreateLimitCommand cliCommand) {
