...
public record TransactionCommand(BigDecimal amount, String source, Map<Key, String> keys)
    implements CLICommand {

  public static final String STR_REP = "transaction";
  ...
  public enum Key implements KeyValueValidator {
    ...
    TIME("-t", "^\\d{4}-\\d{2}-\\d{2}T(?:[01]\\d|2[0-3]):[0-5]\\d$");
